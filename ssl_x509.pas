...
var
  ...
  X509V3_set_ctx : procedure(ctx: PX509V3_CTX; issuer: PX509; subject: PX509; req: PX509_REQ; crl: PX509_CRL; flags: TC_Int) cdecl = nil;
...
*)
  ...
  d2i_X509_ALGOR: function(var a: PX509_ALGOR; var _in: PAnsiChar; len: TC_LONG): PX509_ALGOR; cdecl = nil;
  i2d_X509_ALGOR: function(a: PX509_ALGOR; var _out: PAnsiChar): TC_INT; cdecl = nil;

  X509_EXTENSION_new: function: PX509_EXTENSION; cdecl = nil;
  d2i_X509_EXTENSION: function(var a: PX509_EXTENSION; var _in: PAnsiChar; len: TC_LONG): PX509_EXTENSION; cdecl = nil;
  i2d_X509_EXTENSION: function(a: PX509_EXTENSION; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_ATTRIBUTE: function(var a: PX509_ATTRIBUTE; var _in: PAnsiChar; len: TC_LONG): PX509_ATTRIBUTE; cdecl = nil;
  i2d_X509_ATTRIBUTE: function(a: PX509_ATTRIBUTE; var _out: PAnsiChar): TC_INT; cdecl = nil;
  X509_ATTRIBUTE_it: function: PASN1_ITEM; cdecl = nil;
  d2i_X509_REQ: function(var a: PX509_REQ; var _in: PAnsiChar; len: TC_LONG): PX509_REQ; cdecl = nil;
  i2d_X509_REQ: function(a: PX509_REQ; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_REQ_INFO: function(var a: PX509_REQ_INFO; var _in: PAnsiChar; len: TC_LONG): PX509_REQ_INFO; cdecl = nil;
  i2d_X509_REQ_INFO: function(a: PX509_REQ_INFO; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_SIG: function(var a: PX509_SIG; var _in: PAnsiChar; len: TC_LONG): PX509_SIG; cdecl = nil;
  i2d_X509_SIG: function(a: PX509_SIG; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_PUBKEY: function(var a: PX509_PUBKEY; var _in: PAnsiChar; len: TC_LONG): PX509_PUBKEY; cdecl = nil;
  i2d_X509_PUBKEY: function(a: PX509_PUBKEY; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_VAL: function(var a: PX509_VAL; var _in: PAnsiChar; len: TC_LONG): PX509_VAL; cdecl = nil;
  i2d_X509_VAL: function(a: PX509_VAL; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_NAME_ENTRY: function(var a: PX509_NAME_ENTRY; var _in: PAnsiChar; len: TC_LONG): PX509_NAME_ENTRY; cdecl = nil;
  i2d_X509_NAME_ENTRY: function(a: PX509_NAME_ENTRY; var _out: PAnsiChar): TC_INT; cdecl = nil;
  X509_NAME_ENTRY_it: function: PASN1_ITEM; cdecl = nil;
  d2i_X509_NAME: function(var a: PX509_NAME; var _in: PAnsiChar; len: TC_LONG): PX509_NAME; cdecl = nil;
  i2d_X509_NAME: function(a: PX509_NAME; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_CINF: function(var a: PX509_CINF; var _in: PAnsiChar; len: TC_LONG): PX509_CINF; cdecl = nil;
  i2d_X509_CINF: function(a: PX509_CINF; var _out: PAnsiChar): TC_INT; cdecl = nil;
  X509_CINF_it: function: PASN1_ITEM; cdecl = nil;
  d2i_X509: function(var a: PX509; var _in: PAnsiChar; len: TC_LONG): PX509; cdecl = nil;
  i2d_X509: function(a: PX509; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_CERT_AUX: function(var a: PX509_CERT_AUX; var _in: PAnsiChar; len: TC_LONG): PX509_CERT_AUX; cdecl = nil;
  i2d_X509_CERT_AUX: function(a: PX509_CERT_AUX; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_CERT_PAIR: function(var a: PX509_CERT_PAIR; var _in: PAnsiChar; len: TC_LONG): PX509_CERT_PAIR; cdecl = nil;
  i2d_X509_CERT_PAIR: function(a: PX509_CERT_PAIR; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_REVOKED: function(var a: PX509_REVOKED; var _in: PAnsiChar; len: TC_LONG): PX509_REVOKED; cdecl = nil;
  i2d_X509_REVOKED: function(a: PX509_REVOKED; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_CRL_INFO: function(var a: PX509_CRL_INFO; var _in: PAnsiChar; len: TC_LONG): PX509_CRL_INFO; cdecl = nil;
  i2d_X509_CRL_INFO: function(a: PX509_CRL_INFO; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_X509_CRL: function(var a: PX509_CRL; var _in: PAnsiChar; len: TC_LONG): PX509_CRL; cdecl = nil;
  i2d_X509_CRL: function(a: PX509_CRL; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_NETSCAPE_SPKI: function(var a: PNETSCAPE_SPKI; var _in: PAnsiChar; len: TC_LONG): PNETSCAPE_SPKI; cdecl = nil;
  i2d_NETSCAPE_SPKI: function(a: PNETSCAPE_SPKI; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_NETSCAPE_SPKAC: function(var a: PNETSCAPE_SPKAC; var _in: PAnsiChar; len: TC_LONG): PNETSCAPE_SPKAC; cdecl = nil;
  i2d_NETSCAPE_SPKAC: function(a: PNETSCAPE_SPKAC; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_NETSCAPE_CERT_SEQUENCE: function(var a: PNETSCAPE_CERT_SEQUENCE; var _in: PAnsiChar; len: TC_LONG): PNETSCAPE_CERT_SEQUENCE; cdecl = nil;
  i2d_NETSCAPE_CERT_SEQUENCE: function(a: PNETSCAPE_CERT_SEQUENCE; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_PROXY_POLICY: function(var a: PPROXY_POLICY; var _in: PAnsiChar; len: TC_LONG): PPROXY_POLICY; cdecl = nil;
  i2d_PROXY_POLICY: function(a: PPROXY_POLICY; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_PROXY_CERT_INFO_EXTENSION: function(var a: PPROXY_CERT_INFO_EXTENSION; var _in: PAnsiChar; len: TC_LONG): PPROXY_CERT_INFO_EXTENSION; cdecl = nil;
  i2d_PROXY_CERT_INFO_EXTENSION: function(a: PPROXY_CERT_INFO_EXTENSION; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_BASIC_CONSTRAINTS: function(var a: PBASIC_CONSTRAINTS; var _in: PAnsiChar; len: TC_LONG): PBASIC_CONSTRAINTS; cdecl = nil;
  i2d_BASIC_CONSTRAINTS: function(a: PBASIC_CONSTRAINTS; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_SXNET: function(var a: PSXNET; var _in: PAnsiChar; len: TC_LONG): PSXNET; cdecl = nil;
  i2d_SXNET: function(a: PSXNET; var _out: PAnsiChar): TC_INT; cdecl = nil;
  SXNET_it: function: PASN1_ITEM; cdecl = nil;
  SXNETID_new: function: PSXNETID; cdecl = nil;
  SXNETID_free: procedure(a: PSXNETID); cdecl = nil;
  d2i_SXNETID: function(var a: PSXNETID; var _in: PAnsiChar; len: TC_LONG): PSXNETID; cdecl = nil;
  i2d_SXNETID: function(a: PSXNETID; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_AUTHORITY_KEYID: function(var a: PAUTHORITY_KEYID; var _in: PAnsiChar; len: TC_LONG): PAUTHORITY_KEYID; cdecl = nil;
  i2d_AUTHORITY_KEYID: function(a: PAUTHORITY_KEYID; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_PKEY_USAGE_PERIOD: function(var a: PPKEY_USAGE_PERIOD; var _in: PAnsiChar; len: TC_LONG): PPKEY_USAGE_PERIOD; cdecl = nil;
  i2d_PKEY_USAGE_PERIOD: function(a: PPKEY_USAGE_PERIOD; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_GENERAL_NAME: function(var a: PGENERAL_NAME; var _in: PAnsiChar; len: TC_LONG): PGENERAL_NAME; cdecl = nil;
  i2d_GENERAL_NAME: function(a: PGENERAL_NAME; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_GENERAL_NAMES: function(var a: PGENERAL_NAMES; var _in: PAnsiChar; len: TC_LONG): PGENERAL_NAMES; cdecl = nil;
  i2d_GENERAL_NAMES: function(a: PGENERAL_NAMES; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_OTHERNAME: function(var a: POTHERNAME; var _in: PAnsiChar; len: TC_LONG): POTHERNAME; cdecl = nil;
  i2d_OTHERNAME: function(a: POTHERNAME; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_EDIPARTYNAME: function(var a: PEDIPARTYNAME; var _in: PAnsiChar; len: TC_LONG): PEDIPARTYNAME; cdecl = nil;
  i2d_EDIPARTYNAME: function(a: PEDIPARTYNAME; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_EXTENDED_KEY_USAGE: function(var a: PEXTENDED_KEY_USAGE; var _in: PAnsiChar; len: TC_LONG): PEXTENDED_KEY_USAGE; cdecl = nil;
  i2d_EXTENDED_KEY_USAGE: function(a: PEXTENDED_KEY_USAGE; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_CERTIFICATEPOLICIES: function(var a: PCERTIFICATEPOLICIES; var _in: PAnsiChar; len: TC_LONG): PCERTIFICATEPOLICIES; cdecl = nil;
  i2d_CERTIFICATEPOLICIES: function(a: PCERTIFICATEPOLICIES; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_POLICYINFO: function(var a: PPOLICYINFO; var _in: PAnsiChar; len: TC_LONG): PPOLICYINFO; cdecl = nil;
  i2d_POLICYINFO: function(a: PPOLICYINFO; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_POLICYQUALINFO: function(var a: PPOLICYQUALINFO; var _in: PAnsiChar; len: TC_LONG): PPOLICYQUALINFO; cdecl = nil;
  i2d_POLICYQUALINFO: function(a: PPOLICYQUALINFO; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_USERNOTICE: function(var a: PUSERNOTICE; var _in: PAnsiChar; len: TC_LONG): PUSERNOTICE; cdecl = nil;
  i2d_USERNOTICE: function(a: PUSERNOTICE; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_NOTICEREF: function(var a: PNOTICEREF; var _in: PAnsiChar; len: TC_LONG): PNOTICEREF; cdecl = nil;
  i2d_NOTICEREF: function(a: PNOTICEREF; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_CRL_DIST_POINTS: function(var a: PCRL_DIST_POINTS; var _in: PAnsiChar; len: TC_LONG): PCRL_DIST_POINTS; cdecl = nil;
  i2d_CRL_DIST_POINTS: function(a: PCRL_DIST_POINTS; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_DIST_POINT: function(var a: PDIST_POINT; var _in: PAnsiChar; len: TC_LONG): PDIST_POINT; cdecl = nil;
  i2d_DIST_POINT: function(a: PDIST_POINT; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_DIST_POINT_NAME: function(var a: PDIST_POINT_NAME; var _in: PAnsiChar; len: TC_LONG): PDIST_POINT_NAME; cdecl = nil;
  i2d_DIST_POINT_NAME: function(a: PDIST_POINT_NAME; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_ISSUING_DIST_POINT: function(var a: PISSUING_DIST_POINT; var _in: PAnsiChar; len: TC_LONG): PISSUING_DIST_POINT; cdecl = nil;
  i2d_ISSUING_DIST_POINT: function(a: PISSUING_DIST_POINT; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_ACCESS_DESCRIPTION: function(var a: PACCESS_DESCRIPTION; var _in: PAnsiChar; len: TC_LONG): PACCESS_DESCRIPTION; cdecl = nil;
  i2d_ACCESS_DESCRIPTION: function(a: PACCESS_DESCRIPTION; var _out: PAnsiChar): TC_INT; cdecl = nil;
  ...
  d2i_AUTHORITY_INFO_ACCESS: function(var a: PAUTHORITY_INFO_ACCESS; var _in: PAnsiChar; len: TC_LONG): PAUTHORITY_INFO_ACCESS; cdecl = nil;
  i2d_AUTHORITY_INFO_ACCESS: function(a: PAUTHORITY_INFO_ACCESS; var _out: PAnsiChar): TC_INT; cdecl = nil;
  AUTHORITY_INFO_ACCESS_it: function: PASN1_ITEM; cdecl = nil;

  SXNET_add_id_asc: function(var psx: PSXNET;  _zone: PAnsiChar;  _user: PAnsiChar;_userlen: TC_INT): TC_INT; cdecl = nil;
  SXNET_add_id_ulong: function(var psx: PSXNET; e: TC_ULONG; _user: PAnsiChar;_userlen: TC_INT): TC_INT; cdecl = nil;
  SXNET_add_id_INTEGER: function(var psx: PSXNET; izone: PASN1_INTEGER;  _user: PAnsiChar; _userlen: TC_INT): TC_INT; cdecl = nil;
  ...
  GENERAL_NAME_get0_otherName: function(gen: PGENERAL_NAME; var poid: PASN1_OBJECT; var pvalue: PASN1_TYPE): TC_INT; cdecl = nil;
  ...
  X509V3_EXT_add_nconf_sk: function(conf: PCONF; ctx: PX509V3_CTX;  _section: PAnsiChar; var sk: PSTACK_OF_X509_EXTENSION): TC_INT; cdecl = nil;
  ...
  X509V3_add_value_bool_nf: function( _name: PAnsiChar; _asn1_bool: TC_INT; var extlist: PSTACK_OF_CONF_VALUE): TC_INT; cdecl = nil;
  X509V3_get_value_bool: function(value: PCONF_VALUE; var _asn1_bool: TC_INT): TC_INT; cdecl = nil;
  X509V3_get_value_int: function(value: PCONF_VALUE; var aint: PASN1_INTEGER): TC_INT; cdecl = nil;
