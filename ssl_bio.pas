...
var
  ...
  BIO_accept: function(sock: TC_INT; var ip_port: PAnsiChar): TC_INT; cdecl = nil;
  ...
  BIO_new_bio_pair: function (var bio1: PBIO; writebuf1: TC_SIZE_T; var bio2: PBIO; writebuf2: TC_SIZE_T): TC_INT;
  ...
  BIO_nread0: function(bio: PBIO; var buf: PAnsiChar): TC_INT; cdecl = nil;
  BIO_nread: function(bio: PBIO; var buf: PAnsiChar; num: TC_INT): TC_INT; cdecl = nil;
  BIO_number_read: function(bio: PBIO): TC_ULONG; cdecl = nil;
  BIO_number_written: function(bio: PBIO): TC_ULONG; cdecl = nil;
  BIO_nwrite0: function(bio: PBIO; var buf: PAnsiChar): TC_INT; cdecl = nil;
  BIO_nwrite: function(bio: PBIO; var buf: PAnsiChar; num: TC_INT): TC_INT; cdecl = nil;
