...
begin
  ...
  begin
     ...
     @EVP_MD_flags:= LoadFunctionCLib('EVP_MD_flags');
     ...
     @EVP_CIPHER_CTX_nid:= LoadFunctionCLib('EVP_CIPHER_CTX_nid');
     ...
     @EVP_CIPHER_CTX_copy:= LoadFunctionCLib('EVP_CIPHER_CTX_copy');
     ...
     @EVP_read_pw_string_min:= LoadFunctionCLib('EVP_read_pw_string_min');
     ...
     @EVP_DigestSignInit:= LoadFunctionCLib('EVP_DigestSignInit');
     @EVP_DigestSignFinal:= LoadFunctionCLib('EVP_DigestSignFinal');
     @EVP_DigestVerifyInit:= LoadFunctionCLib('EVP_DigestVerifyInit');
     @EVP_DigestVerifyFinal:= LoadFunctionCLib('EVP_DigestVerifyFinal');
     ...
     @EVP_mdc2:= LoadFunctionCLib('EVP_mdc2');
     @EVP_ripemd160:= LoadFunctionCLib('EVP_ripemd160');
     @EVP_whirlpool:= LoadFunctionCLib('EVP_whirlpool');
     ...
     @EVP_rc4_hmac_md5:= LoadFunctionCLib('EVP_rc4_hmac_md5');
     ...
     @EVP_aes_128_ctr:= LoadFunctionCLib('EVP_aes_128_ctr');
     @EVP_aes_128_gcm:= LoadFunctionCLib('EVP_aes_128_gcm');
     @EVP_aes_128_ccm:= LoadFunctionCLib('EVP_aes_128_ccm');
     @EVP_aes_128_xts:= LoadFunctionCLib('EVP_aes_128_xts');
     ...
     @EVP_aes_192_ctr:= LoadFunctionCLib('EVP_aes_192_ctr');
     @EVP_aes_192_gcm:= LoadFunctionCLib('EVP_aes_192_gcm');
     @EVP_aes_192_ccm:= LoadFunctionCLib('EVP_aes_192_ccm');
     ...
     @EVP_aes_256_ctr:= LoadFunctionCLib('EVP_aes_256_ctr');
     @EVP_aes_256_gcm:= LoadFunctionCLib('EVP_aes_256_gcm');
     @EVP_aes_256_ccm:= LoadFunctionCLib('EVP_aes_256_ccm');
     @EVP_aes_256_xts:= LoadFunctionCLib('EVP_aes_256_xts');
     @EVP_aes_128_cbc_hmac_sha1:= LoadFunctionCLib('EVP_aes_128_cbc_hmac_sha1');
     @EVP_aes_256_cbc_hmac_sha1:= LoadFunctionCLib('EVP_aes_256_cbc_hmac_sha1');
     @EVP_camellia_128_ecb:= LoadFunctionCLib('EVP_camellia_128_ecb');
     @EVP_camellia_128_cbc:= LoadFunctionCLib('EVP_camellia_128_cbc');
     @EVP_camellia_128_cfb1:= LoadFunctionCLib('EVP_camellia_128_cfb1');
     @EVP_camellia_128_cfb8:= LoadFunctionCLib('EVP_camellia_128_cfb8');
     @EVP_camellia_128_cfb128:= LoadFunctionCLib('EVP_camellia_128_cfb128');
     @EVP_camellia_128_ofb:= LoadFunctionCLib('EVP_camellia_128_ofb');
     @EVP_camellia_192_ecb:= LoadFunctionCLib('EVP_camellia_192_ecb');
     @EVP_camellia_192_cbc:= LoadFunctionCLib('EVP_camellia_192_cbc');
     @EVP_camellia_192_cfb1:= LoadFunctionCLib('EVP_camellia_192_cfb1');
     @EVP_camellia_192_cfb8:= LoadFunctionCLib('EVP_camellia_192_cfb8');
     @EVP_camellia_192_cfb128:= LoadFunctionCLib('EVP_camellia_192_cfb128');
     @EVP_camellia_192_ofb:= LoadFunctionCLib('EVP_camellia_192_ofb');
     @EVP_camellia_256_ecb:= LoadFunctionCLib('EVP_camellia_256_ecb');
     @EVP_camellia_256_cbc:= LoadFunctionCLib('EVP_camellia_256_cbc');
     @EVP_camellia_256_cfb1:= LoadFunctionCLib('EVP_camellia_256_cfb1');
     @EVP_camellia_256_cfb8:= LoadFunctionCLib('EVP_camellia_256_cfb8');
     @EVP_camellia_256_cfb128:= LoadFunctionCLib('EVP_camellia_256_cfb128');
     @EVP_camellia_256_ofb:= LoadFunctionCLib('EVP_camellia_256_ofb');
     @EVP_seed_ecb:= LoadFunctionCLib('EVP_seed_ecb');
     @EVP_seed_cbc:= LoadFunctionCLib('EVP_seed_cbc');
     @EVP_seed_cfb128:= LoadFunctionCLib('EVP_seed_cfb128');
     @EVP_seed_ofb:= LoadFunctionCLib('EVP_seed_ofb');
     ...
     @EVP_CIPHER_do_all:= LoadFunctionCLib('EVP_CIPHER_do_all');
     @EVP_CIPHER_do_all_sorted:= LoadFunctionCLib('EVP_CIPHER_do_all_sorted');
     @EVP_MD_do_all:= LoadFunctionCLib('EVP_MD_do_all');
     @EVP_MD_do_all_sorted:= LoadFunctionCLib('EVP_MD_do_all_sorted');
     @EVP_PKEY_decrypt_old:= LoadFunctionCLib('EVP_PKEY_decrypt_old');
     @EVP_PKEY_encrypt_old:= LoadFunctionCLib('EVP_PKEY_encrypt_old');
     @EVP_PKEY_type:= LoadFunctionCLib('EVP_PKEY_type');
     @EVP_PKEY_id:= LoadFunctionCLib('EVP_PKEY_id');
     @EVP_PKEY_base_id:= LoadFunctionCLib('EVP_PKEY_base_id');
     @EVP_PKEY_bits:= LoadFunctionCLib('EVP_PKEY_bits');
     @EVP_PKEY_size:= LoadFunctionCLib('EVP_PKEY_size');
     @EVP_PKEY_set_type:= LoadFunctionCLib('EVP_PKEY_set_type');
     @EVP_PKEY_set_type_str:= LoadFunctionCLib('EVP_PKEY_set_type_str');
     @EVP_PKEY_assign:= LoadFunctionCLib('EVP_PKEY_assign');
     @EVP_PKEY_get0:= LoadFunctionCLib('EVP_PKEY_get0');
     ...
     @EVP_PKEY_print_public:= LoadFunctionCLib('EVP_PKEY_print_public');
     @EVP_PKEY_print_private:= LoadFunctionCLib('EVP_PKEY_print_private');
     @EVP_PKEY_print_params:= LoadFunctionCLib('EVP_PKEY_print_params');
     @EVP_PKEY_get_default_digest_nid:= LoadFunctionCLib('EVP_PKEY_get_default_digest_nid');
     ...
     @PKCS5_PBKDF2_HMAC:= LoadFunctionCLib('PKCS5_PBKDF2_HMAC');
     ...
     @EVP_PBE_alg_add_type:= LoadFunctionCLib('EVP_PBE_alg_add_type');
     @EVP_PBE_alg_add:= LoadFunctionCLib('EVP_PBE_alg_add');
     @EVP_PBE_find:= LoadFunctionCLib('EVP_PBE_find');
     @EVP_PBE_cleanup:= LoadFunctionCLib('EVP_PBE_cleanup');
     @EVP_PKEY_asn1_get_count:= LoadFunctionCLib('EVP_PKEY_asn1_get_count');
     @EVP_PKEY_asn1_get0:= LoadFunctionCLib('EVP_PKEY_asn1_get0');
     @EVP_PKEY_asn1_find:= LoadFunctionCLib('EVP_PKEY_asn1_find');
     @EVP_PKEY_asn1_find_str:= LoadFunctionCLib('EVP_PKEY_asn1_find_str');
     @EVP_PKEY_asn1_add0:= LoadFunctionCLib('EVP_PKEY_asn1_add0');
     @EVP_PKEY_asn1_add_alias:= LoadFunctionCLib('EVP_PKEY_asn1_add_alias');
     @EVP_PKEY_asn1_get0_info:= LoadFunctionCLib('EVP_PKEY_asn1_get0_info');
     @EVP_PKEY_get0_asn1:= LoadFunctionCLib('EVP_PKEY_get0_asn1');
     @EVP_PKEY_asn1_new:= LoadFunctionCLib('EVP_PKEY_asn1_new');
     @EVP_PKEY_asn1_copy:= LoadFunctionCLib('EVP_PKEY_asn1_copy');
     @EVP_PKEY_asn1_free:= LoadFunctionCLib('EVP_PKEY_asn1_free');
     @EVP_PKEY_asn1_set_public:= LoadFunctionCLib('EVP_PKEY_asn1_set_public');
     @EVP_PKEY_asn1_set_private:= LoadFunctionCLib('EVP_PKEY_asn1_set_private');
     @EVP_PKEY_asn1_set_param:= LoadFunctionCLib('EVP_PKEY_asn1_set_param');
     @EVP_PKEY_asn1_set_free:= LoadFunctionCLib('EVP_PKEY_asn1_set_free');
     @EVP_PKEY_asn1_set_ctrl:= LoadFunctionCLib('EVP_PKEY_asn1_set_ctrl');
     @EVP_PKEY_meth_find:= LoadFunctionCLib('EVP_PKEY_meth_find');
     @EVP_PKEY_meth_new:= LoadFunctionCLib('EVP_PKEY_meth_new');
     @EVP_PKEY_meth_get0_info:= LoadFunctionCLib('EVP_PKEY_meth_get0_info');
     @EVP_PKEY_meth_copy:= LoadFunctionCLib('EVP_PKEY_meth_copy');
     @EVP_PKEY_meth_free:= LoadFunctionCLib('EVP_PKEY_meth_free');
     @EVP_PKEY_meth_add0:= LoadFunctionCLib('EVP_PKEY_meth_add0');
     @EVP_PKEY_CTX_new:= LoadFunctionCLib('EVP_PKEY_CTX_new');
     @EVP_PKEY_CTX_new_id:= LoadFunctionCLib('EVP_PKEY_CTX_new_id');
     @EVP_PKEY_CTX_dup:= LoadFunctionCLib('EVP_PKEY_CTX_dup');
     @EVP_PKEY_CTX_free:= LoadFunctionCLib('EVP_PKEY_CTX_free');
     @EVP_PKEY_CTX_set0_keygen_info:= LoadFunctionCLib('EVP_PKEY_CTX_set0_keygen_info');
     @EVP_PKEY_CTX_set_data:= LoadFunctionCLib('EVP_PKEY_CTX_set_data');
     @EVP_PKEY_CTX_set_app_data:= LoadFunctionCLib('EVP_PKEY_CTX_set_app_data');
     @EVP_PKEY_CTX_ctrl:= LoadFunctionCLib('EVP_PKEY_CTX_ctrl');
     @EVP_PKEY_CTX_ctrl_str:= LoadFunctionCLib('EVP_PKEY_CTX_ctrl_str');
     @EVP_PKEY_CTX_get_operation:= LoadFunctionCLib('EVP_PKEY_CTX_get_operation');
     @EVP_PKEY_new_mac_key:= LoadFunctionCLib('EVP_PKEY_new_mac_key');
     @EVP_PKEY_CTX_get_data:= LoadFunctionCLib('EVP_PKEY_CTX_get_data');
     @EVP_PKEY_CTX_get0_pkey:= LoadFunctionCLib('EVP_PKEY_CTX_get0_pkey');
     @EVP_PKEY_CTX_get0_peerkey:= LoadFunctionCLib('EVP_PKEY_CTX_get0_peerkey');
     @EVP_PKEY_CTX_get_app_data:= LoadFunctionCLib('EVP_PKEY_CTX_get_app_data');
     @EVP_PKEY_sign_init:= LoadFunctionCLib('EVP_PKEY_sign_init');
     @EVP_PKEY_sign:= LoadFunctionCLib('EVP_PKEY_sign');
     @EVP_PKEY_verify_init:= LoadFunctionCLib('EVP_PKEY_verify_init');
     @EVP_PKEY_verify:= LoadFunctionCLib('EVP_PKEY_verify');
     @EVP_PKEY_verify_recover_init:= LoadFunctionCLib('EVP_PKEY_verify_recover_init');
     @EVP_PKEY_verify_recover:= LoadFunctionCLib('EVP_PKEY_verify_recover');
     @EVP_PKEY_encrypt_init:= LoadFunctionCLib('EVP_PKEY_encrypt_init');
     @EVP_PKEY_encrypt:= LoadFunctionCLib('EVP_PKEY_encrypt');
     @EVP_PKEY_decrypt_init:= LoadFunctionCLib('EVP_PKEY_decrypt_init');
     @EVP_PKEY_decrypt:= LoadFunctionCLib('EVP_PKEY_decrypt');
     @EVP_PKEY_derive_init:= LoadFunctionCLib('EVP_PKEY_derive_init');
     @EVP_PKEY_derive_set_peer:= LoadFunctionCLib('EVP_PKEY_derive_set_peer');
     @EVP_PKEY_derive:= LoadFunctionCLib('EVP_PKEY_derive');
     @EVP_PKEY_paramgen_init:= LoadFunctionCLib('EVP_PKEY_paramgen_init');
     @EVP_PKEY_paramgen:= LoadFunctionCLib('EVP_PKEY_paramgen');
     @EVP_PKEY_keygen_init:= LoadFunctionCLib('EVP_PKEY_keygen_init');
     @EVP_PKEY_keygen:= LoadFunctionCLib('EVP_PKEY_keygen');
     @EVP_PKEY_CTX_set_cb:= LoadFunctionCLib('EVP_PKEY_CTX_set_cb');
