...
var
    ...
    COMP_compress_block(ctx: PCOMP_CTX; _out: PAnsiChar; olen: TC_INT;_in: PAnsiChar; ilen: TC_INT): TC_INT; cdecl = nil;
    COMP_expand_block(ctx: PCOMP_CTX; _out: PAnsiChar; olen: TC_INT;_in: PAnsiChar; ilen: TC_INT): TC_INT; cdecl = nil;
...
begin
  ...
  begin
    ...
    @BIO_f_zlib:= LoadFunctionCLib('BIO_f_zlib');
  end;
end;
